...
import { nodeTypes as operationNodeTypes } from '@/renderer/features/flowchart/components/operation-config-nodes';
import { nodeTypes as driveNodeTypes } from '@/renderer/features/flowchart/components/drive-config-nodes';
